...
public class TrailValidator : AbstractValidator<TrailDto>
{
    public TrailValidator()
    {
        ...
        RuleFor(x => x.Description).NotEmpty().WithMessage("Plese enter a description");
        RuleFor(x => x.Location).NotEmpty().WithMessage("Plese enter a location");
        RuleFor(x => x.Length).NotEmpty().WithMessage("Plese enter a length");
        RuleFor(x => x.Route).NotEmpty().WithMessage("Plese enter a route description");
